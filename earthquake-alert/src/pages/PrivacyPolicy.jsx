const PrivacyPolicy = () => {
  return (
    <div className="m-5">
      <p>
        <em>
          &lt;지진알리미&gt;(&apos;https://earthquake-alert.site/&apos;이하
          &apos;지진알리미&apos;)
        </em>
        는 「개인정보 보호법」 제30조에 따라 정보주체의 개인정보를 보호하고 이와
        관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이
        개인정보 처리방침을 수립·공개합니다.
      </p>
      <p>
        ○ 이 개인정보처리방침은 <em>2023</em>년 <em>5</em>월 <em>30</em>일부터
        적용됩니다.
      </p>
      <br />
      <p>
        <strong>
          ...
          는 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고 있는
      ...
      <p>
        ...
        <br />
        <br />① <em>&lt;지진알리미&gt;</em>는 법령에 따른 개인정보 보유·이용기간
      ...
      <ul>
        ...
        <li>
          ...
          동의일로부터&lt;탈퇴시까지 보유&gt;까지 위 이용목적을 위하여
          보유.이용됩니다.
        </li>
        <li>보유근거 : 회원 식별</li>
        <li>관련법령 : </li>
      ...
      <p>
        ...
        <br />
        <br /> ① <em>&lt;지진알리미&gt;</em>는 다음의 개인정보 항목을 처리하고
        있습니다.
      </p>
      <ul>
        <li>1. &lt;홈페이지 회원가입 및 관리&gt;</li>
      ...
      <p>
        <br />
        ① &lt;지진알리미&gt;는 개인정보 보유기간의 경과, 처리목적 달성 등
        ...
        1. 파기절차
        <br />
        &lt;지진알리미&gt;는 파기 사유가 발생한 개인정보 선정하고,
        &lt;지진알리미&gt;의 개인정보 보호책임자의 승인을 받아 개인정보를
        파기합니다.
        <br />
      </p>
      <p>2. 파기방법</p>
      ...
      <p>
        <br />① 정보주체는 지진알리미에 대해 언제든지 개인정보
        열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수 있습니다.
      </p>
      <p>
        ② 제1항에 따른 권리 행사는지진알리미에 대해 「개인정보 보호법」 시행령
        제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수
        있으며 지진알리미는 이에 대해 지체 없이 조치하겠습니다.
      </p>
      <p>
      ...
      <p>
        ⑥ 지진알리미는 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구,
      ...
      <p>
        <br />
        지진알리미는 정보주체의 이용정보를 저장하고 수시로 불러오는
      ...
      <br />
      <p>
        ① <span>지진알리미</span>는 개인정보 처리에 관한 업무를 총괄해서
      ...
      <ul>
        ...
        <li>직책 :팀원</li>
        <li>직급 :팀원</li>
        <li>연락처 : denirokr22@gmail.com </li>
      </ul>
      <p>
        ※ 개인정보 보호 담당부서로 연결됩니다.
        <p />
        ...
        <p>
          ② 정보주체께서는 지진알리미의 서비스(또는 사업)을 이용하시면서 발생한
          모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을
          개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. 지진알리미 는
      ...
      <p>① 이 개인정보처리방침은 2023년 5월 30부터 적용됩니다.</p>
      <p></p>
      <p></p>
