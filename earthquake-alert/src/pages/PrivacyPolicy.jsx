  ...
  return (
    <div className="m-5">
      ...
      <p>
        ...
        <br />
        <br />① <em>&lt;지진알리미&gt;</em>은(는) 법령에 따른 개인정보
      ...
      <p>
        ...
        <br />
        <br /> ① <em>&lt;지진알리미&gt;</em>은(는) 다음의 개인정보 항목을
        처리하고 있습니다.
      </p>
      <ul>
        <li>1&lt; 홈페이지 회원가입 및 관리&gt;</li>
      ...
      <p>
        <br />
        &lt; 지진알리미&gt; 은(는) 개인정보 보유기간의 경과, 처리목적 달성 등
        ...
        1. 파기절차
        <br />
        &lt;지진알리미&gt; 은(는) 파기 사유가 발생한 개인정보 선정하고,
      ...
      <p>
        ...
        있으며 지진알리미은(는) 이에 대해 지체 없이 조치하겠습니다.
      </p>
      <p>
      ...
      <p>
        ⑥ 지진알리미은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구,
      ...
      <p>
        <br />
        <br />
        지진알리미 은(는) 정보주체의 이용정보를 저장하고 수시로 불러오는
        ‘쿠키(cookie)’를 사용하지 않습니다.
        <p>
          <strong>제8조 (개인정보 보호책임자에 관한 사항) </strong>
        </p>
        <p>
          ① <span>지진알리미</span> 은(는) 개인정보 처리에 관한 업무를 총괄해서
        ...
        <p>
          ...
          <p>
            <strong>
              ...
              <br />
              &lt;지진알리미&lt;은(는) 정보주체의 개인정보 열람청구가 신속하게
              처리되도록 노력하겠습니다.
            </strong>
          </p>
          <ul>
