...
const SocialLoginModal = ({ showModal, handleCloseModal }) => {
  const handleGoogleLogin = () => {
    ...
    //window.location.href = 'http://server.earthquake-alert.site/auth/authorize/google';
  };

  const handleKakaoLogin = () => {
    window.location.href = "http://localhost:8081/auth/authorize/kakao";
    //window.location.href = 'http://server.earthquake-alert.site/auth/authorize/kakao';
  };

  const handleNaverLogin = () => {
    window.location.href = "http://localhost:8081/auth/authorize/naver";
    //window.location.href = 'http://server.earthquake-alert.site/auth/authorize/naver';
  };
